...
function initialize_contact_map_map__0() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(55.776917, -52),
    ...
    map = new google.maps.Map(document.getElementById('contact-map-map--0'), mapOptions);
    ...
    var myLatLng = new google.maps.LatLng(55.776917, -52);
